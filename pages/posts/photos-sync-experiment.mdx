...
<p><a href="https://photos.app.goo.gl/Jo5ruxkwXHEZQdqE7" className="gp-video-link">
  <Media
...
<p><a href="https://photos.app.goo.gl/6DwvhAUYFh9nSvkR6" className="gp-video-link">
  <Media
...
<p><a href="https://photos.app.goo.gl/2KVm2JsYEqTpKdnB7" className="gp-video-link">
  <Media
...
> _Note that you can only add media items that have been [uploaded by your application](https://developers.google.com/photos/library/guides/upload-media) to [albums that your application has created](https://developers.google.com/photos/library/guides/manage-albums#creating-new-album)._
> 
...
<p><a href="https://photos.app.goo.gl/wsGLJDcfZinMDEKo9" className="gp-video-link">
  <Media
