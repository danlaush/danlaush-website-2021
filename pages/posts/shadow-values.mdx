...
export const data = {
  title: "Shadow values",
  date: "2023-03-04",
  description: "Reflecting on autonomous teams",
...
This is more challenging for us than some other companies. It's not in our DNA, because we've intentionally picked the other direction more of the time. It's the __shadow value__ that comes along with autonomy. When you pick a value you're making a choice, and choices have consequences.

>  I've also heard these referred to as ["anti-values"](https://willsewell.com/posts/2022-02-15-what-are-your-companys-anti-values.html). On the other hand, "shadow values" can instead have a more nefarious meaning - [when what we say differs from what we do](https://ethics.org.au/shadow-values-what-lies-beneath/). This post is about the former.
