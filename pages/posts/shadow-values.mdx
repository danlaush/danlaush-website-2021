...
This is more challenging for us than some other companies. It's not in our DNA, because we've intentionally picked the other direction more of the time. It's the __shadow value__ that comes along with autonomy. When you pick a value, you're making a choice, and that has consequences.
