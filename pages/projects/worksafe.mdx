...
<Container>
<MediaSection
  src="/media/worksafe/desktop.png"
  alt="WorkSafe homepage"
  width={3840}
  height={2160}
/>
...
<MediaSection
  src="/media/worksafe/storybook.png"
  alt="WorkSafe Storybook, showing a list of components, an example render of the Accordion component, and its documentation"
  width={2280}
  height={1354}
  caption="Components were documented in Storybook"
/>
